# Asynchronous Subagents[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#asynchronous-subagents)
...
## Invoking Subagents[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#invoking-subagents)
...
## Built-In Subagents[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#built-in-subagents)
...
## Defining Custom Subagents (.md)[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#defining-custom-subagents-md)
...
### Agent Location and Discovery[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#agent-location-and-discovery)
...
### Frontmatter Configuration (YAML)[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#frontmatter-configuration-yaml)
...
### System Prompt & Markdown Body[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#system-prompt--markdown-body)
...
### Example Markdown Custom Agent (`code-auditor.md`)[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#example-markdown-custom-agent-code-auditormd)
...
## Subagent Lifecycle and States[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#subagent-lifecycle-and-states)

Subagents run asynchronously in the background. At any point during a session, a subagent exists in one of three states:

### 1\. Running[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#1-running)
...
### 2\. Idle[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#2-idle)
...
### 3\. Killed[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#3-killed)
...
## Inter-Agent Communication & Nesting Limits[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#inter-agent-communication--nesting-limits)
...
## Permissions and Configuration Inheritance[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#permissions-and-configuration-inheritance)
...
## Multi-Agent Teamwork (Ultra Plan Only)[link](https://antigravity.google/docs/subagents?_gl=1*8s8sjf*_up*MQ..*_ga*MTM0MTAwOTE0NS4xNzg2NTM0MzEw*_ga_47V54ZJ3EV*czE3ODY1MzQzMDkkbzEkZzAkdDE3ODY1MzQzMzckajMyJGwwJGgw#multi-agent-teamwork-ultra-plan-only)
